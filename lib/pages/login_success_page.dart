...
import 'package:capstone_flutter/pages/home_page.dart';
import 'package:capstone_flutter/pages/my_page.dart';
import 'package:capstone_flutter/pages/order_list_page.dart';
import 'package:capstone_flutter/pages/search_page.dart';
import 'package:capstone_flutter/pages/subscribe_page.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          //         const BorderSide(color: Color(0xFFBB0000))),
          //   ),
          //   child: const Text(
          //     "로그아웃",
          //     style: TextStyle(
          //         color: Color(0xFFBB0000), fontWeight: FontWeight.w700),
          //   ),
          // ),
          IconButton(
            onPressed: () {},
